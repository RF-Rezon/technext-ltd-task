            ...
            <dialog id="my_modal_4" className="modal">
              <div className="modal-box w-11/12 max-w-full">
                        ...
                        <div className="md:basis-3/5 h-full">
                            <div className="grid grid-cols-5 gap-5">
                                {users?.users?.slice(0,20).map(each=> (
                                    <img className="w-24 place-self-center" src={each.image} key={each.id}/>
                                ))}
                            </div>
                        </div>
                </div>
                ...
                <div className="modal-action">
                  <form method="dialog">
                    <button className="btn border-none hover:bg-red-200 hover:outline-none active:outline-none text-sm font-medium">Close</button>
                  </form>
                </div>
              </div>
            </dialog>
